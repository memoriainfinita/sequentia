...
.archive/                                  ← spec v1, POCs descartados y assets de referencia (gitignored)
```
...
### 2026-09-24 — Terminado

- En `2_finished`. GitHub Pages desde `master` en raíz: https://memoriainfinita.github.io/sequentia/
- Los efectos de movimiento de la sesión 24 están integrados en `master`
- Movidos a `.archive/`: `sequentia - backup.html`, `examples/frames and backgrounds/`, `examples/test/`, el zip del intento con Gemini y el plan de 2026-03-28
- `state.md` y `CLAUDE.md` versionados
